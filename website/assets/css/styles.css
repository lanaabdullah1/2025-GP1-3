...
.bg-danger {
  background-color:#6e6e6a !important;
}
.bg-purple {
...
.btn-danger:hover, .btn-danger:focus, .btn-danger:active{
	background:#314d6e !important;
	border-color:#314d6e !important;
	color:#ffffff !important;
}
.btn-outline-danger{
	background:transparent;
...
.btn-light-danger:hover, .btn-light-danger:focus, .btn-light-danger:active{
	background:#6e6e6a !important;
	border-color:#6e6e6a !important;
	color:#ffffff !important;
}
.btn-success{
	background:#009868;
...
.nav-toggle:before {
    ...
    border-radius: 10px;
    box-shadow: 0 .5em 0 0 #6e6e6a, 0 1em 0 0 #e5c0c7;
}
...
.nav-menu>li:hover>a .submenu-indicator-chevron {
    border-color: transparent #6e6e6a #6e6e6a transparent
}
...
.cluster-visible {
    ...
    background: radial-gradient(circle, #6e6e6a 35%, #6e6e6a 100%) !important;
    border-radius: 50%;
...
.property-listing.property-1 .listing-detail-btn .more-btn {
    padding: 6px 12px;
    color: #ffffff;
    border: 1px solid #6e6e6a !important;
    background: #6e6e6a !important;
    border-radius: 2px;
}
...
.dash_user_menues ul li.active a {
    color: #3f628b;
    font-weight: 600;
    background: rgba(63, 98, 139, 0.08);
}

.dash_user_menues ul li.active a::before {
    content: "";
    position: absolute;
    left: 0;
    top: 20%;
...
._leads_status .undernegotiation{
    padding: 3px 15px;
    background: #ffeddb;
    border-radius: 50px;
    font-size: 12px;
...
.bg-primary{
background-color: #314d6e !important;
}

.text-primary{
    color: #314d6e !important;
...
.bg-blue{
    ...
    border: 1px solid #2B6BAF !important;
}
